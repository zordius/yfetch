...
describe(`yfetch [${target}.js]`, () => {
  ...
  describe('yfetch()', () => {
    ...
    describe('(functional tests)', () => {
      ...
      it('should failed', () => yfetch({ url: '_should_error_' }))

      it('should failed with context', () => yfetch({ url: '_should_error_' }).catch((error) => {
      ...
      it('should support timeout', () => yfetch({ url: MOCK_URLS.OK_DELAY2, timeout: 100 }).catch((error) => {
        expect(error.response).toEqual({})
      ...
      it('should threat code 200 as error', yfetch({ url: MOCK_URLS.OK, error: [100, 200, 300] }).catch((err) => {
